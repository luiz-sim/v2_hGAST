...
subroutine init_regulation(array1, array2)
   ...
   !DEC$ END IF
   real(mk), dimension(100), intent(in ) :: array1
   real(mk), dimension(1)  , intent(out) :: array2
   ! Local vars
   integer i, ifejl
...
!qq--- Added by GL
  ...
  ! Default and derived parameters
   ...
   switchfirstordervar%tau = 2.0_mk*pi/GenSpeedRefMax                     !*array1(74)
   MoniVar%rystevagtfirstordervar%tau = 2.0_mk*pi/GenSpeedRefMax          !*array1(75)
   SafetySystemVar%rystevagtfirstordervar%tau = 2.0_mk*pi/GenSpeedRefMax  !*array1(75)
   ! Wind speed table
...
!j DT_damper%bandpass%f0     = array1(10)
   ...
   DT_damper%bandpass%zeta   = 0.02_mk                            !array1(59)  !qq 0.7_mk BUG jimfixed
   DT_damper%notch%zeta2     = 0.01_mk                            !array1(60)
   DT_damper%Td              = 0.0_mk                             !array1(61)
   ! -Tower top fore-aft mode damper [disabled if gain=0.]
   TTfa_damper%bandpass%f0   = 1.0_mk                             !array1(62)
   TTfa_damper%notch%f0      = 1.0_mk                             !array1(63)
   TTfa_damper%bandpass%zeta = 0.7_mk                             !array1(64)
   TTfa_damper%notch%zeta2   = 0.01                               !array1(65)
   TTfa_damper%gain          = 0.0_mk                             !array1(66)
   TTfa_damper%Td            = 1.0_mk                             !array1(67)
   TTfa_PWRfirstordervar%tau = 1.0_mk                             !array1(68)
...
subroutine init_regulation_advanced(array1, array2)
   ...
   SafetySystemVar%rystevagtfirstordervar%tau = array1(75)*2.0_mk*pi/GenSpeedRefMax
   ! Gear ratio
   GearRatio                          = array1(76)
   ! Initialization
   TimerExcl = -0.02_mk
...
subroutine update_regulation(array1, array2)
   ...
   array2( 4) = PitchColRef            !    5: Pitch angle reference of blade 3         [rad]
   array2( 5) = dump_array(1)          !    6: Power reference                          [W]
   array2( 6) = dump_array(2)          !    7: Filtered wind speed                      [m/s]
   array2( 7) = dump_array(3)          !    8: Filtered rotor speed                     [rad/s]
   array2( 8) = dump_array(4)          !    9: Filtered rotor speed error for torque    [rad/s]
   array2( 9) = dump_array(5)          !   10: Bandpass filtered rotor speed            [rad/s]
   array2(10) = dump_array(6)          !   11: Proportional term of torque contr.       [Nm]
   array2(11) = dump_array(7)          !   12: Integral term of torque controller       [Nm]
   array2(12) = dump_array(8)          !   13: Minimum limit of torque                  [Nm]
   array2(13) = dump_array(9)          !   14: Maximum limit of torque                  [Nm]
   array2(14) = dump_array(10)         !   15: Torque limit switch based on pitch       [-]
   array2(15) = dump_array(11)         !   16: Filtered rotor speed error for pitch     [rad/s]
   array2(16) = dump_array(12)         !   17: Power error for pitch                    [W]
   array2(17) = dump_array(13)         !   18: Proportional term of pitch controller    [rad]
   array2(18) = dump_array(14)         !   19: Integral term of pitch controller        [rad]
   array2(19) = dump_array(15)         !   20: Minimum limit of pitch                   [rad]
   array2(20) = dump_array(16)         !   21: Maximum limit of pitch                   [rad]
   array2(21) = dump_array(17)         !   22: Torque reference from DT damper          [Nm]
   array2(22) = int(dump_array(18))    !   23: Status signal                            [-]
   array2(23) = dump_array(19)         !   24: Total added pitch rate                   [rad/s]
   array2(24) = dump_array(20)         !   25: Filtered pitch angle                     [rad]
   ...
   array2(27) = dump_array(23)         !   28: LP filtered acceleration level           [m/s^2]
   array2(28) = int(dump_array(24))    !   29: Rotor speed exlusion zone region         [-]
   array2(29) = dump_array(25)         !   30: Filtered tower top acc. for tower damper [m/s^2]
   array2(30) = dump_array(26)         !   31: Reference pitch from tower damper        [rad]


!qq Added by jim
   array2(31) = dump_array(40)         !   31: GenTorqueMin_full    [Nm]
   array2(32) = dump_array(41)         !   32: GenTorqueMax_full    [Nm]
   return
