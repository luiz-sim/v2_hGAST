            ...
            for k in range(0,len(laminates[i])):
                if laminates[i][k]>0.0:
                    ...
                    if k==0 or k==6 or k==8 or k==12:
                        ...
                        C_Grid[i][j].append('purple')
                    elif k==7:
                        C_Grid[i][j].append('blue')
...
def check_grid(X_Grid, Y_Grid, C_Grid, Check):
    ...
    plt.fill_between([], [], [], color='gray',   alpha=0.75, label='FOAM')
    plt.fill_between([], [], [], color='purple',   alpha=0.75, label='CARBON')
    plt.fill_between([], [], [], color='blue',   alpha=0.75, label='GELCOAT')
    for i in range(0,len(X_Grid)):
        for j in range(0,len(X_Grid[i])):
            for k in range(0,len(X_Grid[i][j])):
...
# Mass
#################################################
def mass(Thick_lay, Thick_ele, Length_ele, Center_ele, triax, biax, uniax, balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in):
    den=[]
    for i in range(0,len(Thick_lay)):
        den.append([])
        for j in range(0,len(Thick_lay[i])):
            den[i].append((Thick_lay[i][j][0]*triax[1]+Thick_lay[i][j][1]*biax[1]+Thick_lay[i][j][2]*uniax[1]+Thick_lay[i][j][3]*balsa[1]+Thick_lay[i][j][4]*uniax[1]+Thick_lay[i][j][5]*biax[1]+Thick_lay[i][j][6]*triax[1] +Thick_lay[i][j][7]*gelcoat[1]+Thick_lay[i][j][8]*triax_out[1]+Thick_lay[i][j][9]*carbon[1]+Thick_lay[i][j][10]*uniax_out[1]+Thick_lay[i][j][11]*foam[1]+Thick_lay[i][j][12]*triax_in[1])/sum(Thick_lay[i][j][:]))
...
# Stiffness
#################################################
def stiffness(Thick_lay, Length_lay, Ply_lay, Thick_ele, Length_ele, Theta_ele, Center_ele, triax, biax, uniax, balsa,  gelcoat, triax_out, carbon, uniax_out, foam, triax_in, sc, num_webs, TimFac, F):
    sf = 1.125
    E11=[triax[2], biax[2], uniax[2], balsa[2], uniax[2], biax[2], triax[2], gelcoat[2], triax_out[2], carbon[2], uniax_out[2], foam[2], triax_in[2]] ; E22=[triax[3], biax[3], uniax[3], balsa[3], uniax[3], biax[3], triax[3] , gelcoat[3], triax_out[3], carbon[3], uniax_out[3], foam[3], triax_in[3]] ; v12=[triax[4], biax[4], uniax[4], balsa[4], uniax[4], biax[4], triax[4] , gelcoat[4], triax_out[4], carbon[4], uniax_out[4], foam[4], triax_in[4]]
    G12=[triax[5], biax[5], uniax[5], balsa[5], uniax[5], biax[5], triax[5] , gelcoat[5], triax_out[5], carbon[5], uniax_out[5], foam[5], triax_in[5]] ; G13=[triax[6], biax[6], uniax[6], balsa[6], uniax[6], biax[6], triax[6] , gelcoat[6], triax_out[6], carbon[6], uniax_out[6], foam[6], triax_in[6]] ; G23=[triax[7], biax[7], uniax[7], balsa[7], uniax[7], biax[7], triax[7] , gelcoat[7], triax_out[7], carbon[7], uniax_out[7], foam[7], triax_in[7]]
    xc=[triax[8]/sf,biax[8]/sf,uniax[8]/sf,balsa[8]/sf,uniax[8]/sf,biax[8]/sf,triax[8]/sf , gelcoat[8]/sf, triax_out[8]/sf, carbon[8]/sf, uniax_out[8]/sf, foam[8]/sf, triax_in[8]/sf]        ; xt=[triax[9]/sf,biax[9]/sf,uniax[9]/sf,balsa[9]/sf,uniax[9]/sf,biax[9]/sf,triax[9]/sf , gelcoat[9]/sf, triax_out[9]/sf, carbon[9]/sf, uniax_out[9]/sf, foam[9]/sf, triax_in[9]/sf]
    yc=[triax[10]/sf,biax[10]/sf,uniax[10]/sf,balsa[10]/sf,uniax[10]/sf,biax[10]/sf,triax[10]/sf, gelcoat[10]/sf, triax_out[10]/sf, carbon[10]/sf, uniax_out[10]/sf, foam[10]/sf, triax_in[10]/sf] ; yt=[triax[11]/sf,biax[11]/sf,uniax[11]/sf,balsa[11]/sf,uniax[11]/sf,biax[11]/sf,triax[11]/sf, gelcoat[11]/sf, triax_out[11]/sf, carbon[11]/sf, uniax_out[11]/sf, foam[11]/sf, triax_in[11]/sf]
    st=[triax[12]/sf,biax[12]/sf,uniax[12]/sf,balsa[12]/sf,uniax[12]/sf,biax[12]/sf,triax[12]/sf , gelcoat[12]/sf, triax_out[12]/sf, carbon[12]/sf, uniax_out[12]/sf, foam[12]/sf, triax_in[12]/sf]
...
def shear_center(sc,*arg):
    Thick_lay, Length_lay, Ply_lay, Thick_ele, Length_ele, Theta_ele, Center_ele, triax, biax, uniax, balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,num_webs, TimFac = arg
    ...
    ukn, Tx, Ty = stiffness(Thick_lay, Length_lay, Ply_lay, Thick_ele, Length_ele, Theta_ele, Center_Ele, triax, biax, uniax, balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,sc, num_webs, TimFac, [])
    return Tx, Ty

def STIFFMASS(args):
    profil,radius,chord,twist,pit_ax,kp01,kp02,kp03,kp04,kp05,kp06,kp07,kp08,kp09,kp10,laminates,num_webs,ply,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in= args
    K6x6,SC,M6x6,MC = [],[],[],[]
    for i in range(0,21):
        ...
        m6x6,mc = mass(Thick_lay,Thick_ele,Length_ele,Center_ele,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in)
        Timo=True ; sc=tuple(fsolve(shear_center,[0.0,0.0],args=(Thick_lay,Length_lay,Ply_lay,Thick_ele,Length_ele,Theta_ele,Center_ele,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,num_webs[i],Timo),xtol=0.1))
        k6x6,ukn,ukn = stiffness(Thick_lay,Length_lay,Ply_lay,Thick_ele,Length_ele,Theta_ele,Center_ele,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,sc,num_webs[i],Timo,[])
        K6x6.append(k6x6) ; SC.append(sc) ; M6x6.append(m6x6) ; MC.append(mc)
    return K6x6,SC,M6x6,MC

def STRESSES(args):
    R_tip,r_hup,profil,radius,x_sweep,z_prebent,chord,twist,pit_ax,kp01,kp02,kp03,kp04,kp05,kp06,kp07,kp08,kp09,kp10,laminates,num_webs,ply,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,Loads = args
    StrMax,Length,COST = [],[],[]
    for i in range(0,21):
        airfoil,kp = airfoil_geometry(profil,radius[i],chord[i],twist[i],pit_ax[i],kp01[i],kp02[i],kp03[i],kp04[i],kp05[i],kp06[i],kp07[i],kp08[i],kp09[i],kp10[i])
        Thick_lay,Length_lay,Ply_lay,Thick_ele,Length_ele,Theta_ele,Center_ele,X_Grid,Y_Grid,C_Grid = grid(airfoil,kp,laminates[i],num_webs[i],ply[i])
        Length.append(math.sqrt(((R_tip-r_hup)*radius[i])**2.0+x_sweep[i]**2.0+z_prebent[i]**2.0))
        COST.append(sum([Thick_lay[i][j][0]*Length_lay[i][j][0]*triax[0]*triax[1]+Thick_lay[i][j][1]*Length_lay[i][j][1]*biax[0]*biax[1]+Thick_lay[i][j][2]*Length_lay[i][j][2]*uniax[0]*uniax[1]+Thick_lay[i][j][3]*Length_lay[i][j][3]*balsa[0]*balsa[1]+Thick_lay[i][j][4]*Length_lay[i][j][4]*uniax[0]*uniax[1]+Thick_lay[i][j][5]*Length_lay[i][j][5]*biax[0]*biax[1]+Thick_lay[i][j][6]*Length_lay[i][j][6]*triax[0]*triax[1] +Thick_lay[i][j][7]*Length_lay[i][j][7]*gelcoat[0]*gelcoat[1]+Thick_lay[i][j][8]*Length_lay[i][j][8]*triax_out[0]*triax_out[1]+Thick_lay[i][j][9]*Length_lay[i][j][9]*carbon[0]*carbon[1]+Thick_lay[i][j][10]*Length_lay[i][j][10]*uniax_out[0]*uniax_out[1]+Thick_lay[i][j][11]*Length_lay[i][j][11]*foam[0]*foam[1]+Thick_lay[i][j][12]*Length_lay[i][j][12]*triax_in[0]*triax_in[1]for i in range(0,len(Thick_lay)) for j in range(0,len(Thick_lay[i]))]))
        Timo=True ; sc=tuple(fsolve(shear_center,[0.0,0.0],args=(Thick_lay,Length_lay,Ply_lay,Thick_ele,Length_ele,Theta_ele,Center_ele,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,num_webs[i],Timo),xtol=0.1))
        ukn,ukn,str_max = stiffness(Thick_lay,Length_lay,Ply_lay,Thick_ele,Length_ele,Theta_ele,Center_ele,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,sc,num_webs[i],Timo,Loads[i])
        StrMax.append(str_max)
    return StrMax#,sum([(COST[i-1]+COST[i])*(Length[i]-Length[i-1])/2.0 for i in range(1,21)])

def COST(args):
    R_tip,r_hup,profil,radius,x_sweep,z_prebent,chord,twist,pit_ax,kp01,kp02,kp03,kp04,kp05,kp06,kp07,kp08,kp09,kp10,laminates,num_webs,ply,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in,CosMod_params = args
    ...
    for i in range(0,21):
        airfoil,kp = airfoil_geometry(profil,radius[i],chord[i],twist[i],pit_ax[i],kp01[i],kp02[i],kp03[i],kp04[i],kp05[i],kp06[i],kp07[i],kp08[i],kp09[i],kp10[i])
        Thick_lay,Length_lay,Ply_lay,Thick_ele,Length_ele,Theta_ele,Center_ele,X_Grid,Y_Grid,C_Grid = grid(airfoil,kp,laminates[i],num_webs[i],ply[i])
        m6x6,ukn = mass(Thick_lay,Thick_ele,Length_ele,Center_ele,triax,biax,uniax,balsa, gelcoat, triax_out, carbon, uniax_out, foam, triax_in)
