...
program pre_hGAST
   ...
   integer(4)::kp(1:30,1:16), kp_nose ! key-points matrix, key-point of nose and impermanent key-points of kp-6, kp-7, kp-10 and kp-11
   integer(4)::kp_2(1:30), kp_3(1:30), kp_4(1:30), kp_5(1:30), kp_6(1:30), kp_7(1:30), kp_8(1:30), kp_9(1:30), kp_10(1:30), kp_11(1:30), kp_12(1:30), kp_13(1:30), kp_14(1:30), kp_15(1:30)
   ...
   real(8)::gra1, gra2, dth(1:30), dkp(1:30)                                            ! gradient-1, gradient-2, angle between initial and move web-a and kp-7 move
...
!              read(1,*) kp(i,1), kp(i,2), kp(i,3), kp(i,4), kp(i,5), kp_6(i), kp_7(i), kp(i,8), kp(i,9), kp_10(i), kp_11(i), kp(i,12), kp(i,13), kp(i,14), kp(i,15), kp(i,16)
               read(1,*) kp(i,1), kp(i,2), kp_3(i), kp_4(i), kp_5(i), kp_6(i), kp_7(i), kp_8(i), kp_9(i), kp_10(i), kp_11(i), kp_12(i), kp_13(i), kp_14(i), kp(i,15), kp(i,16)
            end do
         close (1)
      !--->
      ...
      !--->
         do i=1,30
            kp(i,3)=kp_3(i)+caps_move(i) ; kp(i,9)=kp_9(i)+caps_move(i)
            kp(i,4)=kp_4(i)+caps_move(i) ; kp(i,10)=kp_10(i)+caps_move(i)
            kp(i,5)=kp_5(i)+caps_move(i) ; kp(i,11)=kp_11(i)+caps_move(i)
            kp(i,6)=kp_6(i)+caps_move(i) ; kp(i,12)=kp_12(i)+caps_move(i)
            kp(i,7)=kp_7(i)+caps_move(i) ; kp(i,13)=kp_13(i)+caps_move(i)
            kp(i,8)=kp_8(i)+caps_move(i) ; kp(i,14)=kp_14(i)+caps_move(i)

            if (kp(i,3)<(kp(i,2)+1)) kp(i,3)=kp(i,2)+1     ; if (kp(i,4)<(kp(i,3)+1)) kp(i,4)=kp(i,3)+1
            if (kp(i,5)<(kp(i,4)+1)) kp(i,5)=kp(i,4)+1     ; if (kp(i,6)<(kp(i,5)+1)) kp(i,6)=kp(i,5)+1
            if (kp(i,7)<(kp(i,6)+1)) kp(i,7)=kp(i,6)+1     ; if (kp(i,8)<(kp(i,7)+1)) kp(i,8)=kp(i,7)+1
            if (kp(i,9)<(kp(i,8)+1)) kp(i,9)=kp(i,8)+1     ; if (kp(i,10)<(kp(i,9)+1)) kp(i,10)=kp(i,9)+1
            if (kp(i,11)<(kp(i,10)+1)) kp(i,11)=kp(i,10)+1 ; if (kp(i,12)<(kp(i,11)+1)) kp(i,12)=kp(i,11)+1 
            if (kp(i,13)<(kp(i,12)+1)) kp(i,13)=kp(i,12)+1 ; if (kp(i,14)<(kp(i,13)+1)) kp(i,14)=kp(i,13)+1
